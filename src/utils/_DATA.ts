let users = {
  sarahedo: {
    ...
    name: "Sarah Edo",
    avatarURL:
      "https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/128/Binance-Coin-BNB-icon.png",
    answers: {
  ...
  johndoe: {
    ...
    name: "John Doe",
    avatarURL:
      "https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/128/Aeron-ARN-icon.png",
    answers: {
...
export function _saveQuestion(question: any) {
  return new Promise((res, rej) => {
    ...
    setTimeout(() => {
      ...
      res({ questionRes: formattedQuestion });
    }, 1000);
  });
}
